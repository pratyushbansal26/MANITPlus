...
public class RecyclerAdapter_Attendance_AllSubjects extends RecyclerView.Adapter<RecyclerAdapter_Attendance_AllSubjects.SubjectViewHolder> {

    Context context;
    ArrayList<AttendanceFragment.Subject_Item> arrayList;

    RecyclerAdapter_Attendance_AllSubjects(Context context, ArrayList<AttendanceFragment.Subject_Item> arrayList)
    {
    ...
    public SubjectViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recycler_item_all_subjects,parent,false);
